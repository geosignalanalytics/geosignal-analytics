...
const PILLARS = [
  {
    num: '01',
    title: 'Multi-Method Joint Inversion',
    desc: 'Combining gravity, magnetic, airborne EM, and electrical resistivity datasets into unified 3D subsurface models, to reduce ambiguity rather than relying on any single method.',
  },
  {
    num: '02',
    title: 'Physics-Guided Target Identification',
    desc: 'Machine learning models constrained by petrophysical relationships, used to flag high-probability mineralization targets across large regional datasets.',
  },
  {
    num: '03',
    title: 'Structural & Geological Lineament Mapping',
    desc: 'Computer vision and spatial edge-detection on satellite and airborne geophysical grids, to extract fault networks, shear zones, and structural conduits.',
  },
  {
    num: '04',
    title: 'Remote & Deep Target Prospecting',
    desc: 'Signal enhancement and noise suppression techniques aimed at identifying deeply buried or covered mineral reserves in under-explored terrain.',
  },
];
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-400 text-base md:text-lg leading-relaxed mb-10">
              Modernizing mineral prospecting by combining physical geoscience constraints with AI-driven
              interpretation, aimed at better targeting with less field risk.
            </p>
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 py-16 flex-1 w-full space-y-12">
        ...
        <article className="bg-[#0b1329] border border-slate-800/80 rounded-xl p-6 sm:p-10 space-y-5">
          ...
          <div className="space-y-4 text-slate-400 text-base leading-relaxed">
            <p>
              This area drives the technological side of mineral prospecting: fusing physical geoscience
              constraints with deep learning interpretation to improve subsurface resource targeting while
              cutting down on unnecessary field exploration and its environmental footprint.
            </p>
            <p className="border-t border-slate-800/80 pt-4">
              In practice: physics-guided AI architectures, joint inversion of multi-method geophysics
              (magnetometry, gravimetry, airborne EM, induced polarization), and automated structural
              mapping for complex or remote mineralized terrain.
            </p>
          </div>
        </article>
        ...
        <div className="bg-[#0b1329] border border-slate-800/80 rounded-xl p-6 sm:p-8">
          ...
          <ul className="space-y-4 text-slate-400 text-sm sm:text-base">
            <li>
              ...
              multi-method joint inversion (gravity, mag, IP), physics-guided AI architectures, structural
              target identification in complex terrain.
            </li>
            <li>
              <strong className="text-white font-semibold">Training &amp; industrial partnerships: </strong>
              joint ventures, industrial exploration partnerships, or workshops on AI-driven prospecting methods.
            </li>
          </ul>

          <div className="mt-8 pt-6 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
            <span className="text-sm text-slate-500">Interested in an exploration partnership?</span>
            <Link 
