...
export default function ResearchArea3Page() {
  ...
  return (
    <div className="min-h-screen bg-[#070b12] text-slate-100 font-sans selection:bg-sky-500 selection:text-white flex flex-col antialiased relative">
      ...
      {/* 2. HERO SECTION */}
      <section 
        className="relative overflow-hidden border-b border-slate-800/80 bg-[#050b14] py-20 px-6 text-center md:px-12 md:py-28"
        style={{ 
          backgroundImage: `linear-gradient(180deg, rgba(5, 11, 20, 0.85) 0%, rgba(7, 11, 18, 0.98) 100%), url('https://images.unsplash.com/photo-1509228468518-180dd4864904?auto=format&fit=crop&w=1920&q=80')`,
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          ...
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-white mb-6 leading-tight drop-shadow-md">
            Seismic Imaging &amp;<br />
          ...
          <p className="text-slate-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed mb-8 drop-shadow">
            Combining active and passive wave-propagation physics with computational inversion to dynamically image sub-surface structures and monitor geohazards over time.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link 
              href="/institute/publications" 
              className="inline-flex items-center gap-2 rounded-xl bg-sky-500 hover:bg-sky-400 px-6 py-3 text-sm font-semibold text-slate-950 shadow-lg shadow-sky-500/20 transition-all hover:scale-105"
            >
      ...
      <section className="border-b border-slate-800/80 bg-slate-900/30 py-6 px-6 backdrop-blur-md">
        <div className="mx-auto max-w-5xl flex flex-wrap justify-around items-center gap-4 text-center text-xs sm:text-sm font-medium text-slate-300">
          ...
          <div className="flex items-center gap-2 bg-slate-900/80 border border-slate-800 px-4 py-2 rounded-xl shadow-sm">
            ...
            Active &amp; Passive Wavefield Simulation
          </div>
          <div className="flex items-center gap-2 bg-slate-900/80 border border-slate-800 px-4 py-2 rounded-xl shadow-sm">
            <span className="h-2 w-2 rounded-full bg-indigo-400"></span>
            Automated Hazard Forecasting
          </div>
        </div>
      </section>
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 py-16 flex-1 w-full space-y-12">
        ...
        <article className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-6 sm:p-10 shadow-xl backdrop-blur-md space-y-6">
          ...
          <div className="space-y-4 pt-2 text-slate-300 text-base sm:text-lg leading-relaxed">
            <p>
              <strong className="text-sky-400 font-semibold">Focus:</strong> Center on structural dynamic imaging and risk management. By fusing physics-based wave-propagation modeling with advanced computational inversion, this pillar continuously tracks sub-surface physical transformations and pore-pressure dynamics over time.
            </p>
            <p className="border-t border-slate-800/80 pt-4">
              <strong className="text-white font-semibold">Scope:</strong> High-resolution Full Waveform Inversion (FWI), active and passive data integration, wavefield numerical simulations, and automated forecasting for geological, civil, and environmental hazards.
            </p>
          </div>
        </article>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-slate-900/30 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition-colors space-y-3">
              ...
              <h4 className="text-lg font-bold text-white">Full Waveform Inversion (FWI)</h4>
              <p className="text-slate-300 text-sm leading-relaxed">
                Developing elastic and viscoelastic FWI algorithms to construct high-contrast velocity and density models of complex geological formations from multi-component seismic records.
              </p>
            </div>
            ...
            <div className="bg-slate-900/30 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition-colors space-y-3">
              ...
              <h4 className="text-lg font-bold text-white">Passive &amp; Microseismic Monitoring</h4>
              <p className="text-slate-300 text-sm leading-relaxed">
                Leveraging continuous ambient noise and induced seismicity to detect micro-fracture propagation, pore-pressure shifts, and stress field changes in real time.
              </p>
            </div>
            ...
            <div className="bg-slate-900/30 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition-colors space-y-3">
              ...
              <h4 className="text-lg font-bold text-white">Physics-Based Wavefield Simulation</h4>
              <p className="text-slate-300 text-sm leading-relaxed">
                Modeling 3D wave propagation in anisotropic and heterogeneous media to simulate seismic response under extreme geological and geotechnical scenarios.
              </p>
            </div>
            ...
            <div className="bg-slate-900/30 border border-slate-800/80 rounded-2xl p-6 hover:border-slate-700 transition-colors space-y-3">
              ...
              <h4 className="text-lg font-bold text-white">Automated Geohazard Forecasting</h4>
              <p className="text-slate-300 text-sm leading-relaxed">
                Integrating physical wave-field metrics with probabilistic machine learning to assess fault reactivation risks, ground motion, and structural slope stability.
              </p>
            </div>
        ...
        <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-6 sm:p-8 shadow-xl backdrop-blur-md">
          <h3 className="text-xl font-bold text-white mb-4">Collaborate on Seismic &amp; Monitoring Projects</h3>
          <ul className="space-y-4 text-slate-300 text-sm sm:text-base">
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                For technical questions regarding wavefield simulation, full waveform inversion (FWI), passive monitoring, or hazard assessment algorithms.
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-sky-400 font-bold text-lg leading-none">•</span>
              <div>
                ...
                To discuss collaborative monitoring networks, software integration, or technical workshops on advanced seismic data processing.
              </div>
            </li>
          </ul>
          ...
          <div className="mt-8 pt-6 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
            <span className="text-xs font-mono text-slate-400">Ready to initiate a monitoring collaboration?</span>
            <Link 
            ...
            >
              Send a Seismic Research Inquiry ↗
            </Link>
          </div>
        </div>
