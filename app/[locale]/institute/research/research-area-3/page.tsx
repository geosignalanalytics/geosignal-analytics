...
const PILLARS = [
  {
    ...
    desc: 'Elastic and viscoelastic FWI algorithms to build high-contrast velocity and density models of complex geological formations from multi-component seismic records.',
  },
  {
    num: '02',
    title: 'Passive & Microseismic Monitoring',
    desc: 'Continuous ambient noise and induced seismicity used to detect micro-fracture propagation, pore-pressure shifts, and stress field changes as they happen.',
  },
  {
    num: '03',
    title: 'Physics-Based Wavefield Simulation',
    desc: '3D wave propagation modeling in anisotropic and heterogeneous media, to simulate seismic response under extreme geological and geotechnical scenarios.',
  },
  {
    num: '04',
    title: 'Automated Geohazard Forecasting',
    desc: 'Physical wave-field metrics combined with probabilistic machine learning to assess fault reactivation risk, ground motion, and slope stability.',
  },
];
    ...
    <div className="min-h-screen bg-[#060a12] text-slate-100 font-sans selection:bg-cyan-500/30 selection:text-cyan-200 flex flex-col antialiased">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-400 text-base md:text-lg leading-relaxed mb-10">
              Combining active and passive wave-propagation physics with computational inversion to image
              subsurface structures and track geohazards over time.
            </p>
      ...
      <section className="border-b border-slate-800/70 bg-[#0b1329]/50 py-4 px-6">
        <div className="mx-auto max-w-5xl flex flex-wrap justify-center items-center gap-3 sm:gap-6 text-xs sm:text-sm text-slate-400">
          <span>High-resolution seismic inversion</span>
          <span className="text-slate-700">•</span>
          <span>Active &amp; passive wavefield simulation</span>
          <span className="text-slate-700">•</span>
          <span>Automated hazard forecasting</span>
        </div>
      </section>
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 py-16 flex-1 w-full space-y-12">
        ...
        <article className="bg-[#0b1329] border border-slate-800/80 rounded-xl p-6 sm:p-10 space-y-5">
          ...
          <div className="space-y-4 text-slate-400 text-base leading-relaxed">
            <p>
              This area focuses on structural dynamic imaging and risk management: fusing physics-based
              wave-propagation modeling with computational inversion to track subsurface physical change
              and pore-pressure dynamics over time.
            </p>
            <p className="border-t border-slate-800/80 pt-4">
              In practice: high-resolution full waveform inversion (FWI), active and passive data
              integration, wavefield numerical simulation, and automated forecasting for geological,
              civil, and environmental hazards.
            </p>
          </div>
        </article>
        ...
        <div className="bg-[#0b1329] border border-slate-800/80 rounded-xl p-6 sm:p-8">
          ...
          <ul className="space-y-4 text-slate-400 text-sm sm:text-base">
            <li>
              ...
              technical questions on wavefield simulation, full waveform inversion (FWI), passive
              monitoring, or hazard assessment algorithms.
            </li>
            <li>
              <strong className="text-white font-semibold">Training &amp; partnerships: </strong>
              collaborative monitoring networks, software integration, or workshops on seismic data processing.
            </li>
          </ul>

          <div className="mt-8 pt-6 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4">
            <span className="text-sm text-slate-500">Interested in a monitoring collaboration?</span>
            <Link 
